...
def main():
    ...
    for dataset in [Path("datasets/unified_validation_set.tsv"), Path("datasets/unified_validation_set_downsampled.tsv")]:
        ...
        plt.tight_layout()
        plt.savefig(f"plots/{dataset.stem}_validation_unique_word_distribution.png")

        plt.figure()
        sns.boxplot(data=data, x="Input length", y="MAFALDA Superlabel")
        plt.tight_layout()
        plt.savefig(f"plots/{dataset.stem}_validation_text_length_distribution.png")
        ...
        plt.tight_layout()
        plt.savefig(f"plots/{dataset.stem}_validation_superlabel_distribution.png")
        ...
        plt.tight_layout()
        plt.savefig(f"plots/{dataset.stem}_validation_label_distribution.png")
        ...
        plt.tight_layout()
        plt.savefig(f"plots/{dataset.stem}_validation_label_vocab_size_distribution.png")
