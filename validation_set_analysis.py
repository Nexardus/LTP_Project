...
def main():
    ...
    plt.figure()
    sns.countplot(data=data, x="MAFALDA Superlabel", order = data['MAFALDA Superlabel'].value_counts().index)
    plt.tight_layout()
    ...
    sns.countplot(data=data, x="MAFALDA Label", order = data['MAFALDA Label'].value_counts().index, hue="MAFALDA Superlabel")
    plt.tight_layout()
